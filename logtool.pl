...
my (%options,%options_cli);                 #store all options got from cli
...
sub cfgfparse2{     #{{{3}}}
        #this function deal with sepcial handlings for some clauses
...
sub readfrom{   #{{{3}}}
    #this function deal with readfrom function for each clause
...
sub login{  #{{{3}}}
    #this function checks the login params(param1) and trying to login remote box
...
sub stsplit{   #{{{3}}}
    #split (ref of£©show-tech output into a (ref of)hash
...
sub cmds2cmdsoutputs{   #{{{3}}}
    #this fucntion use @cmds as input,use telnet object to login the box
...
sub prehandle{  #{{{3}}}
    #this function do some pre-handling:
        #    create dir for logs
...
sub lr_time{    #{{{3}}}
    #calculate and return local/remote time based on 2 input:
